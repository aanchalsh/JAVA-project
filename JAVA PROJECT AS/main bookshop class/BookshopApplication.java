...
public class BookshopApplication {
			...
			if (isUserLoggedIn && userType == 1) {
				...
				try {
					do {
						System.out.println();
						System.out
								.println("Welcome to BMSCE BookShop - Logged in as BORROWER");
						System.out
								.println("-------------------------------------------------------");
				...
				try {
					do {
						System.out.println();
						System.out.println("Welcome to BMSCE BookShop - Logged in as LENDER");
						System.out.println("-----------------------------------------------------");
						System.out.println("1) Search the books by name");
						System.out.println("2) Search the books by author name");
						System.out.println("3) Search the books by price range");
				...
				try {
					do {
						System.out.println();
						System.out.println(
								"Welcome to BMSCE BookShop - Logged in as BORROWER/LENDER/BUYER");
						System.out.println(
								"------------------------------------------------------------------");
						System.out.println("1) Search the books by name");
						System.out.println("2) Search the books by author name");
				...
				try {
					do {
						System.out.println();
						System.out.println("Welcome to BMSCE BookShop --ADMIN LOGIN");
						System.out.println("----------------------------------------------");
						System.out.println("1) Search the books by name");
						System.out.println("2) Search the books by author name");
						System.out.println("3) Search the books by price range");
	...
	public static void displayWelcomeMenu() {
		...
		System.out.println();
		System.out.println("Welcome to BMSCE BookShop");
		System.out.println("-------------------------------");
